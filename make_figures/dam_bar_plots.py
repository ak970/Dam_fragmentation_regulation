...
for count, basin in enumerate(basin_ls):
    # big_dams = gp.read_file(data_folder+"grand_data/2010/"+basin+"_segGeo.shp", index_col='Hydroseq', usecols=['Hydroseq', 'DamID','Norm_stor'])
    all_dams = gp.read_file(data_folder+"2010/"+basin+"_segGeo.shp", index_col='Hydroseq',
